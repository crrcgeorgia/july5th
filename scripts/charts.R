...
ggsave("visuals/crosstabs/vaccinated_demography.svg", width=12, height=5)
...
ggsave("visuals/crosstabs/not_enough_information_demography.svg", width=12, height=5)
...
ggsave("visuals/crosstabs/know_booking_demography.svg", width=12, height=5)
